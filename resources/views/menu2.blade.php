 ...
 <li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Demander :</h6>
            <a class="collapse-item" href="{{ url('/demander/create') }}">demander</a>
            <a class="collapse-item" href="{{ url('/suivi') }}">suivi les demandes</a>
            <a class="collapse-item" href="{{ url('/d_accepter_employee') }}">suivi les Remboursement</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <a class="nav-link dropdown-toggle" href="login" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::guard('employee')->user()->nom }}</span>
